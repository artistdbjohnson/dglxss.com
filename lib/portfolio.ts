...
export function projectSections(p: PortfolioProject, locale: Locale): { id: string; title: string; body: string }[] {
  return p.sections.map((s) => ({ id: s.id, title: sectionTitle(s, locale), body: sectionBody(s, locale) }));
}
...
export const PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    line: {
      en: "Website redesign for a Bay Area luxury kitchen, bath, and whole-home remodeler — real job photos, working trust links, exact marketing words.",
      pt: "Redesign do site para um remodelador de luxo de cozinhas, casas de banho e habitação na Bay Area — fotos reais de obra, links de confiança a funcionar, palavras de marketing exactas.",
    },
    kind: ["web"],
    year: "2026",
    status: "shipped",
    ...
    sections: [
      ...
      { id: "elevation", title: { en: "What I built", pt: "O que construí" }, body: {
        en: "Dark-first editorial luxury, bronze accent, stacked manifesto hero, numbered services with quiet chips. Portfolio cards keep their published titles and now sit on real completed rooms — kitchens, baths, decks, patio pours. A Yelp photo frieze runs job pictures from the field and points at their 337-photo album. Provenance chips leave the page: CSLB #1044943 on the state lookup, Angi Super Service, Yelp 5.0 from 14 reviews. Privacy, terms, and accessibility are real pages. Exact service and process copy. EN/PT and dark/light throughout. Footer: built by dglxss.",
        pt: "Luxo editorial dark-first, acento bronze, hero manifesto em stack, serviços numerados com chips quietos. Os cards de portfólio mantêm os títulos publicados e assentam agora em divisões reais concluídas — cozinhas, casas de banho, decks, pátios. Uma frisa de fotos Yelp corre imagens de obra no terreno e aponta para o álbum de 337 fotos. Os chips de proveniência saem da página: CSLB #1044943 no lookup do Estado, Angi Super Service, Yelp 5.0 em 14 reviews. Privacidade, termos e acessibilidade são páginas reais. Copy exacto de serviços e processo. EN/PT e dark/light em todo o site. Footer: construído por dglxss.",
      }},
      { id: "stack", title: { en: "Stack", pt: "Stack" }, body: {
        en: "Next.js and React. Tailwind for the system. Instrument Serif and Inter for type. Their job photography plus the Yelp field set. Framer Motion for quiet reveals and the photo frieze. Deployed on Vercel.",
        pt: "Next.js e React. Tailwind para o sistema. Instrument Serif e Inter na tipografia. A fotografia de obra deles mais o conjunto de campo do Yelp. Framer Motion para reveals quietos e a frisa de fotos. Publicado na Vercel.",
      }},
      { id: "outcome", title: { en: "Outcome", pt: "Resultado" }, body: {
        en: "A Bay Area remodeler site that shows the rooms they actually finished, with license and reviews you can tap through — live at luxury-home-remodeling.vercel.app.",
        pt: "Um site de remodelação na Bay Area que mostra as divisões que realmente acabaram, com licença e reviews em que se pode clicar — live em luxury-home-remodeling.vercel.app.",
      }},
    ],
  },
  {
  ...
  },
  {
    ...
    buildId: "checkclock",
    sections: [
      { id: "status", title: { en: "Status", pt: "Estado" }, body: {
      ...
      { id: "focus", title: { en: "Focus", pt: "Foco" }, body: {
      ...
      { id: "open", title: { en: "Open build", pt: "Build aberto" }, body: {
