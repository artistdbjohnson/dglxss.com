...
export const UI = {
  ...
  caseTabsAria: { en: "Case sections", pt: "Secções do caso" },
  tabBrief: { en: "Brief", pt: "Brief" },
  tabBefore: { en: "Before", pt: "Antes" },
  tabBuilt: { en: "Built", pt: "Feito" },
  tabStack: { en: "Stack", pt: "Stack" },
  tabOutcome: { en: "Outcome", pt: "Resultado" },
  tabBuild: { en: "Build", pt: "Build" },
  tabStatus: { en: "Status", pt: "Estado" },
  livePlate: { en: "Live", pt: "Live" },
  scanHint: {
    en: "Use the tabs to read each part of the case.",
    pt: "Use os separadores para ler cada parte do caso.",
  },
